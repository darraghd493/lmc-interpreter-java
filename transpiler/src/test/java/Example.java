...
import me.darragh.lmc.transpiler.BasicTranspiler;
...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        BasicTranspiler basicTranspiler = new BasicTranspiler(instructions);
        basicTranspiler.build();
        try {
            basicTranspiler.save(Path.of("out.jar"));
        } catch (IOException e) {
